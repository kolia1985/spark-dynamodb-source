 ...
 */
private[dynamodb] sealed trait SparkAWSCredentials extends Serializable {
  /**
...
private[dynamodb] final case object DefaultCredentials extends SparkAWSCredentials {
...
private[dynamodb] final case object InstanceProfileCredentials
 ...
 */
private[dynamodb] final case class BasicCredentials(
 ...
 */
private[dynamodb] final case class STSCredentials(
    stsRoleArn: String,
